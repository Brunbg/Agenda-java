...
public class TelaNotificaCompromissoG extends JFrame {
...
//	}
	...
	public TelaNotificaCompromissoG() {
			setResizable(false);
			setTitle("Remover");
			...
			btnNotificar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try {
						Fachada.notificarCompromissoGrupo(idcompromisso,"fausto123");
			...
			btnNotificar.setBounds(160, 296, 89, 23);
